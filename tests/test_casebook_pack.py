"""Regression checks for the thread-chain-index-lab casebook."""
...
from casebook.harness import assert_expected, thread_chain_index_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(thread_chain_index_lab_summary(), assert_expected())
